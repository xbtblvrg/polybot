from scripts import run_btc5m_polymarket_cross_asset_leader_lag as lane
...
def test_generation_checksum_is_frozen_and_distinct():
    assert lane.CHECKSUM == "b0d3bf95de98a746b1fad3aac9f1294c54b53f2fd216a888313a227f0bc37f6a"
