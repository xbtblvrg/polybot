#!/usr/bin/env python3
"""Install and start the persistent top10 direct-CLOB paper service."""
...
def build_launchd_payload(*, python: str, stdout: str, stderr: str) -> dict[str, Any]:
    return {
        ...
        "ProgramArguments": [
            python,
            str(ROOT / "scripts/run_top10_direct_clob_paper_service.py"),
            "--max-book-fetches",
            "20",
        ],
...
def main() -> int:
    ...
    parser.add_argument("--stdout", default="data/research/runtime_logs/top10_direct_clob_paper.out.log")
    parser.add_argument("--stderr", default="data/research/runtime_logs/top10_direct_clob_paper.err.log")
