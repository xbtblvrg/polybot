#!/usr/bin/env python3
"""Install and start the persistent paper-only f418 spread shadow service."""
...
LABEL = "com.belavarga.polymarket.f418-spread-elasticity-shadow"
...
def build_launchd_payload(*, python: str, stdout: str, stderr: str) -> dict[str, Any]:
    return {
        ...
        "ProgramArguments": [
            python,
            str(ROOT / "scripts/run_f418_spread_elasticity_shadow_service.py"),
        ],
...
def main() -> int:
    ...
    parser.add_argument("--stdout", default="data/research/runtime_logs/f418_spread_elasticity_shadow.out.log")
    parser.add_argument("--stderr", default="data/research/runtime_logs/f418_spread_elasticity_shadow.err.log")
